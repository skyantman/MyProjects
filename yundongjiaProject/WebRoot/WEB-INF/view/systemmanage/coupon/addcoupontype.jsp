...
<script type="text/javascript">
	...
	function subForm(){
        ...
        var b = false;
        for(var i = 0; i < $("input[name='coupon_type']").length; i++){
        	if($("input[name='coupon_type']").eq(i).is(":checked")){
        		b = true;
        	}
        }
        if(!b){
		...
		$.ajax({
			url : "<%=path%>/yundongjia/insertCouponType",
			type: 'POST',  
            data: data,
            dataType: 'JSON',  
            async : false,
			...
			success : function(data){
				if(data.result){
					...
					maincontent.load('<%=path%>/yundongjia/couponList?status=0&couponId=' + data.id);
					alert(data.message);
				}else{
					alert(data.message);
				}
...
<body>
	<div class="main-content" >
		<div class="page-header">
			当前位置：
			<a href="javascript:void(0)" status="0" >新增优惠券类型</a>
		</div>
		<div>
			 <form id="formInfo" name="form1"   onsubmit="return false;"  method="post">
					<div class="col-md-12">
						...
						<div class="col-md-3 padding0L form-group">	
							<input name="couponname"  class="form-control"  placeholder="请输入券名称">
						</div>  			
					...
					<div class="col-md-12">
						...
						<div class="col-md-3 padding0L form-group">
							<select name="couponmethod" class="form-control btn btn-default" onchange="select(this);">
					...
					<div class="col-md-12">
						...
						<div class="col-md-3 padding0L form-group">
							<input type="number" class="form-control" name="validday" >	
						</div>  
						<label class="xing">*</label>  	
					</div>
					<div class="col-md-12">
						...
						<div class="col-md-3 padding0L form-group">	
							...
							<div class="col-md-6 padding0L" style="margin-left: -15px;">
									<input disabled="disabled" name="stockNum"  class="form-control"  placeholder="库存数" style="max-width: 100px;padding-left: 0px">													
							</div>
						</div>  			
					</div>
					<div class="col-md-12">
						...
						<div class="col-md-10 padding0L form-group">	
								<div class="col-md-1" >
									<input type="checkbox"  name="coupon_type"  value="0"   onclick="shohi(this);">全部
								</div>
								<div id="soh" class="col-md-10 padding0L">
									<input type="checkbox"  name="coupon_type"  value="1"  style="margin-left: 10px;">场馆
									<input type="checkbox"  name="coupon_type"  value="4"  style="margin-left: 10px;">充值卡
									<input type="checkbox"  name="coupon_type"  value="5"  style="margin-left: 10px;">活动
									<input type="checkbox"  name="coupon_type"  value="6"  style="margin-left: 10px;">私课
									<input type="checkbox"  name="coupon_type"  value="7"  style="margin-left: 10px;">商城
								</div>
						</div>  	
					</div>
					<div id="money">
					...
					<div id="discount"  style="display: none;">
						<div class="col-md-12">
							...
							<div class="col-md-3 padding0L form-group">
								<select name="discount" class="form-control btn btn-default">
						...
						<div class="col-md-12">
							...
							<div class="col-md-3 padding0L form-group">	
								<input name="maxmoney"  class="form-control"  placeholder="请输入金额数">
							</div>  			
							<label class="xing">*</label>  			
						</div>
					</div>
					<div class="col-md-12">
						...
						<div class="col-md-3 padding0L form-group">	
							<input name="startmoney"  class="form-control"  placeholder="请输入起用金额数">
						</div>  			
						<label class="xing">*</label>  			
					</div>
					<div class="col-md-8">
