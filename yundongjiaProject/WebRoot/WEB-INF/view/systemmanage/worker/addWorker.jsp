...
<script type="text/javascript">
	...
	function subForm(){
		...
		$.ajax({
			url : "<%=path%>/yundongjia/insertWorker",
			type: 'POST',  
            data: data,
            dataType: 'JSON',  
            async : false,
...
<body>
	<div class="main-content" >
		<div class="page-header">
			当前位置：
			<a href="javascript:void(0)" status="0" >新增工作人员</a>
		</div>
		<div>
			 <form id="formInfo" name="form1"   onsubmit="return false;"  method="post">
					<div class="col-md-12">
						...
						<div class="col-md-3 padding0L form-group">	
							<input name="backusername"  class="form-control"  placeholder="请输入姓名">
						</div>  			
					...
					<div class="col-md-12">
						...
						<div class="col-md-3 padding0L form-group">
							<input name="backusermobliephone" class="form-control"  placeholder="请输入手机号">
						</div>	
						<label class="xing">*</label>
					</div>
					<div class="col-md-12">
